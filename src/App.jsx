...
function App() {
  ...
  return (
    <>
      ...
      <BrowserRouter>
        <Routes>
            <Route path="https://mishosb.com/budget-app/" element={<Home data={inv} deleteInv={deleteInv} />} />
            <Route path="https://mishosb.com/budget-app/addinvoice" element={<AddInvoice setNewData={setNewData} />} />
